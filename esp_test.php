...
if (isset($_POST['simulate'])) {
    ...
    $ch = curl_init('http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/sensor_api.php');
...
<div class="card">
  ...
  <table>
    ...
    <tr>
      ...
      <td><code style="color:#79c0ff">http://<?= $_SERVER['HTTP_HOST'] ?>/fish_drying/sensor_api.php</code></td>
    </tr>
  </table>
</div>
