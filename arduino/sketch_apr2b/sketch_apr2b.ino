...
String logReadingURL   = "http://192.168.100.39/fishda/api/session_api.php";
String fetchControlURL = "http://192.168.100.39/fishda/api/controls_api.php?action=fetch_controls";
String fetchSessionURL = "http://192.168.100.39/fishda/api/session_api.php?action=poll_session_status";
