...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .bg-campus {
        ...
        background: url('0547b4a4-4216-4045-b7e2-cc42bb6e47af.jpg') center center / cover no-repeat;
    }
    .bg-campus::after {
        content: '';
...
<div class="page-wrap">
    ...
    <div class="brand-side">
        <div class="logo-ring-wrap">
            ...
            <img src="625084455_1314712234011631_2618349884753441586_n.jpg" alt="ISU Logo" class="brand-logo" onerror="this.src='fishlogo.jpg'">
        </div>
